    ...
    <div className="relative md:px-10 px-5 md:py-20 py-12 mx-auto min-h-screen">
      <section className="py-16">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('./68daa8ae1a9bdf1349594ddc_bdf42e7525bf4ac77c533827bfa422c0_smartdata_hero-p-1080.webp')",
          }}
        />
        ...
        <div className="relative max-w-6xl mx-auto md:py-12 text-left bg-[#000]/40 p-8 shadow">
          ...
          >
            <a
              href="/"
              className="md:px-6 px-4 py-3 bg-[#2F6FD6] md:text-base text-xs text-white shadow text-center"
            >
            ...
            <a
              href="/"
              className="md:px-6 px-4 py-3 md:text-base text-xs text-white border border-white border-opacity-50 font-semibold shadow text-center"
            >
              Learn More
            </a>
          </motion.div>
