    ...
    <div className="relative md:px-10 px-5 md:py-20 py-12 mx-auto min-h-screen">
      <section className="py-16">
        ...
        <div className="relative max-w-6xl mx-auto md:py-12 text-left bg-[#000]/40 p-8 shadow">
          ...
          >
            <span className="text-[#2F6FD6]">Transactions Without Slippage</span>{" "}
          ...
          <motion.p
            ...
            className="text-[#D1E0FA] md:text-base text-sm text-opacity-75 mb-6 md:max-w-2xl leading-relaxed pt-5"
          >
